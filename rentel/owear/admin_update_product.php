...
<body>
    ...
    <div class="d-flex">
        ...
        <div class="content w-100">
            <div class="container">
                <h2 class="mt-3 mb-4 text-center">Update Product</h2>
                <form action="" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?= $fetch_products['id']; ?>">

                    <div class="form-row">
                        <div class="form-group">
                            <input type="text" name="name" class="form-control" required value="<?= $fetch_products['name']; ?>" placeholder="Enter product name">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <input type="number" min="0" name="price" class="form-control" required value="<?= $fetch_products['price']; ?>" placeholder="Enter product price">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        <textarea name="details" class="form-control" required placeholder="Enter product details" rows="3"><?= $fetch_products['details']; ?></textarea>
                    </div>
